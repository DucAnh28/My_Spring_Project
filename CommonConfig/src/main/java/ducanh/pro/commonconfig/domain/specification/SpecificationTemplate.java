package ducanh.pro.commonconfig.domain.specification;
...
public class SpecificationTemplate {
    ...
    public static <E> Specification<E> isNotNull(String attr) {
        return (root, query, builder) -> builder.isNotNull(root.get(attr));
    }
